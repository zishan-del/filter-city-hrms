...
// Step 9D.5A Preview shell: stable Step 9D.4 plus read-only Saudi EOSB entitlement preview.
module.exports=async(req,res)=>{
  ...
  try{
    ...
    const saudiPayrollTerminology9D3Ui=fs.readFileSync(path.join(process.cwd(),'saudi-payroll-terminology-9d3-ui.js'),'utf8');
    const saudiEosbTerminology9D4Ui=fs.readFileSync(path.join(process.cwd(),'saudi-eosb-terminology-9d4-ui.js'),'utf8');
    const saudiEosbEntitlement9D5Ui=fs.readFileSync(path.join(process.cwd(),'saudi-eosb-entitlement-9d5-ui.js'),'utf8');
    const step10EmployeesValidationUi=fs.readFileSync(path.join(process.cwd(),'step10-employees-validation-ui.js'),'utf8');
    const step10AttendanceEmployeeFilterUi=fs.readFileSync(path.join(process.cwd(),'step10-attendance-correction-employee-filter-ui.js'),'utf8');
    const storeComplianceUi=fs.readFileSync(path.join(process.cwd(),'store-compliance-ui.js'),'utf8');
    const injected=html.replace('</body>',`<script>\n${taskUi}\n</script>\n<script>\n${leaveUi}\n</script>\n<script>\n${payrollUi}\n</script>\n<script>\n${attendanceFix}\n</script>\n<script>\n${reminderUi}\n</script>\n<script>\n${attendanceReportUi}\n</script>\n<script>\n${currentMonthUi}\n</script>\n<script>\n${payrollPaymentUi}\n</script>\n<script>\n${workScheduleUi}\n</script>\n<script>\n${attendanceRulesUi}\n</script>\n<script>\n${attendanceCorrectionUi}\n</script>\n<script>\n${attendanceCorrectionSaveUi}\n</script>\n<script>\n${attendanceInspectionUi}\n</script>\n<script>\n${attendanceCorrectionReportUi}\n</script>\n<script>\n${themeUi}\n</script>\n<script>\n${bilingualUi}\n</script>\n<script>\n${bilingualPolishUi}\n</script>\n<script>\n${payrollArabicPolishUi}\n</script>\n<script>\n${mobileResponsiveUi}\n</script>\n<script>\n${dashboardRedesignUi}\n</script>\n<script>\n${dashboardRedesignFixUi}\n</script>\n<script>\n${dashboardRedesignPolishUi}\n</script>\n<script>\n${attendanceInspectionPrint9C5Ui}\n</script>\n<script>\n${attendanceAuditPrint9C6Ui}\n</script>\n<script>\n${saudiHrTerminology9D1Ui}\n</script>\n<script>\n${saudiLeaveTerminology9D2Ui}\n</script>\n<script>\n${saudiPayrollTerminology9D3Ui}\n</script>\n<script>\n${saudiEosbTerminology9D4Ui}\n</script>\n<script>\n${saudiEosbEntitlement9D5Ui}\n</script>\n<script>\n${step10EmployeesValidationUi}\n</script>\n<script>\n${step10AttendanceEmployeeFilterUi}\n</script>\n<script>\n${storeComplianceUi}\n</script>\n</body>`);
    res.statusCode=200;
