(function(){
  ...
  style.textContent=`
    ...
    body.fc-theme-9c1 .fc-brand-panel{border:1px solid #ffffff2e;border-radius:12px;padding:12px 10px;margin-bottom:18px;background:#ffffff0d;text-align:center}
    body.fc-theme-9c1 .fc-brand-mark{width:58px;height:58px;margin:0 auto 8px;border-radius:12px;background:#fff;color:var(--fc-navy);border:3px solid var(--fc-red);display:grid;place-items:center;font-weight:900;font-size:22px;letter-spacing:-1px;box-shadow:0 5px 18px #001b3830}
    ...
    body.fc-theme-9c1 .nav button{text-align:left;background:transparent;color:#fff;border-radius:8px;padding:11px 12px;font-weight:600;border-left:3px solid transparent}
    body.fc-theme-9c1 .nav button:hover{background:#ffffff12;border-left-color:#ffffff70}
    body.fc-theme-9c1 .nav button.active{background:linear-gradient(90deg,var(--fc-red),#ef2930);border-left-color:#fff;box-shadow:0 7px 16px #001b3830}
    ...
    body.fc-theme-9c1 .top{height:72px;border-bottom:1px solid var(--fc-line);background:#fff;padding:0 24px;box-shadow:0 2px 10px #001b3808}
    ...
    body.fc-theme-9c1 .hero{background:#fff;color:var(--fc-navy);border:1px solid var(--fc-line);border-left:5px solid var(--fc-red);box-shadow:0 5px 18px #001b3809;border-radius:12px}
    body.fc-theme-9c1 .hero h1{font-weight:900}
    body.fc-theme-9c1 .hero>div{color:var(--fc-muted)}
    body.fc-theme-9c1 .card{border:1px solid var(--fc-line);border-radius:12px;background:#fff;box-shadow:0 4px 14px #001b3808}
    ...
    body.fc-theme-9c1 .section{border:1px solid var(--fc-line);border-radius:12px;background:#fff;box-shadow:0 4px 16px #001b3808}
    ...
    body.fc-theme-9c1 .field input,body.fc-theme-9c1 .field select,body.fc-theme-9c1 .field textarea,body.fc-theme-9c1 input,body.fc-theme-9c1 select,body.fc-theme-9c1 textarea{border-color:#cfd9e5}
    body.fc-theme-9c1 .field input:focus,body.fc-theme-9c1 .field select:focus,body.fc-theme-9c1 .field textarea:focus{outline:2px solid #e31b2320;border-color:var(--fc-red)}
    body.fc-theme-9c1 .toast{background:var(--fc-navy);border-left:4px solid var(--fc-red)}
    body.fc-theme-9c1 .fc-company-strip{display:flex;align-items:center;gap:12px;margin-right:auto;margin-left:20px;color:var(--fc-navy);min-width:0}
    body.fc-theme-9c1 .fc-mini-mark{width:32px;height:32px;border-radius:8px;background:#fff;color:var(--fc-navy);border:2px solid var(--fc-red);display:grid;place-items:center;font-weight:900;font-size:12px;flex:0 0 auto}
    body.fc-theme-9c1 .fc-mini-name{font-size:12px;font-weight:900;white-space:nowrap}
    body.fc-theme-9c1 .fc-mini-ar{font-size:11px;color:var(--fc-red);font-weight:700;white-space:nowrap}
    @media(max-width:1100px){body.fc-theme-9c1 .fc-company-strip{display:none}}
    @media(max-width:850px){body.fc-theme-9c1 .sidebar{padding-top:12px}body.fc-theme-9c1 .top{padding:0 12px}body.fc-theme-9c1 .content{padding:14px}body.fc-theme-9c1 .fc-brand-panel{margin-bottom:12px}}
  `;
  document.head.appendChild(style);
  document.body.classList.add('fc-theme-9c1');

  function applyBranding(){
    if(document.title!=='FILTER CITY TRADING CO. HRMS')document.title='FILTER CITY TRADING CO. HRMS';
    ...
    const desiredTitle=COMPANY_EN+' HRMS';
    if(brandH1&&brandH1.textContent!==desiredTitle)brandH1.textContent=desiredTitle;

    const brandMuted=document.querySelector('.brand .muted');
    if(brandMuted&&!brandMuted.dataset.fcBranded){
      brandMuted.innerHTML='Human Resources Management System<br><span dir="rtl" style="color:#e31b23;font-weight:700">'+COMPANY_AR+'</span>';
      brandMuted.dataset.fcBranded='1';
    }
